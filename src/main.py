...
def main():
    ...
    print('''Что вы хотите увидеть?:
          1 - Посмотреть список всех компаний
           и количество вакансий у каждой компании;
          2 - Посмотреть список всех вакансий с
           указанием названия компании, названия
            вакансии и зарплаты и ссылки на вакансию;
          3 - Посмотреть среднюю зарплату по
           всем вакансиям;
          4 - Посмотреть список всех вакансий,
           у которых зарплата выше средней по всем вакансиям;
          5 - Посмотреть список всех вакансий,
           в названии которых содержатся запрашиваемое слово.''')
    ...
    if user_input == '2':
        for i in new.get_all_vacancies():
            print(f'Компания:{i[0]}, Вакансия:{i[1]},'
                  f' Зарплата от {i[2]} до {i[3]}, Ссылка:{i[4]}')
    elif user_input == '3':
